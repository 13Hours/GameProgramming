...
public class GameFrame extends JFrame implements Runnable, KeyListener {
    ...
    private BallAnim ballAnimation = null;      // animation sprite for disappearing effect
    ...
    private volatile boolean isAnimShown = true;
    ...
    public GameFrame () {
        ...
        bat = new Bat (this, 0, 600, 7, 7, 40, 40, "images/a2Char.png");
        ball = new Ball (this, bat, 0, 0, 10, 10, 20, 20, "images/a2Z_1.png");
        animation = new AnimDisappear (this, 20, 50, 15, 15, 250, 250, "images/a2Z_1.png");
        ballAnimation = new BallAnim (this, bat, 0, 0, 10, 10, 20, 20, "images/a2Z_1.png");
    ...
    */
    ...
    private void gameRender(Graphics gScr){
        ...
        if (isAnimShown){           // draw the animation
            ...
            ballAnimation.draw((Graphics2D)gScr);
        }
  ...
  //            g.drawString("Show Anim", showAnimButtonArea.x+35, showAnimButtonArea.y+25);
    ...
    private void scoreMessage(Graphics g){
        Font font = new Font("SansSerif",Font.BOLD,24);
        int s1=(int)(long)time;
        int s2=(int)(long)Itime;
        int s=(s1-s2)/1000;
        String str=Integer.toString(s);
        String score="Time : "+str;
        int sx=10,sy=20;
        g.setColor(Color.RED);
        g.setFont(font);
        g.drawString(score,sx,sy);
    }
